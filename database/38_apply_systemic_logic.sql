-- 38_apply_systemic_logic.sql

-- 1. Tambah kolom royalty_fee pada tabel sales_items
ALTER TABLE public.sales_items ADD COLUMN IF NOT EXISTS royalty_fee NUMERIC DEFAULT 0;

-- 2. Update fungsi trigger handle_sales_items_mutation() untuk revert stok jika BATAL
...
BEGIN
    ...
    ELSIF TG_OP = 'UPDATE' THEN
        ...
        BEGIN
            ...
            -- LOGIKA PENGEMBALIAN DARI BATAL KE AKTIF (JARANG, TAPI JAGA-JAGA)
            ...
            -- LOGIKA UPDATE QTY BIASA (KEDUANYA BUKAN BATAL)
